...
class Footer extends Component {
  render() {
    return (
      <footer className="bg-green-500 w-full h-18 text-center text-white lg:bg-white lg:text-blue-450 lg:flex lg:px-32 lg:pt-2 lg:w-screen lg:h-20 lg:justify-center lg:absolute lg:bottom-0 lg:left-0 lg:gap-40 lg:items-center lg:py-0">
        ...
        <ul className="lg:flex lg:gap-32  lg:font-body lg:text-xs lg:font-medium">
          ...
          <li className="flex justify-center gap-2 py-4 lg:grid lg:grid-cols-3 lg:content-center lg:gap-4">
            <a href="https://twitter.com/santigeek">
              <img src={Twitter} className="w-8 lg:w-5" alt="" />
            </a>
            <a href="https://www.instagram.com/santigeek22/">
              <img src={Instagram} className="w-8 lg:w-5" alt="" />
            </a>
            <a href="https://www.linkedin.com/in/santiago-gu%C3%A1queta-a7522b132/">
              <img src={Linkedin} className="w-8 lg:w-5" alt="" />
            </a>
          </li>
        </ul>
      </footer>
